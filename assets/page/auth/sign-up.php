                    ...
                    <div class="bg-white py-8 px-8 shadow sm:rounded-lg sm:px-10">
                        <div class="relative">
                            ...
                            <div class="relative flex justify-center text-sm">
                                <span class="bg-white px-2 text-gray-500">สร้างบัญชีใหม่ด้วย</span>
                            </div>
                        </div>
                        ...
                        <?php }
                        unset($_SESSION['signup_errors'], $_SESSION['signup_old'], $_SESSION['success']); ?>
                        <form class="space-y-6 mt-3" action="/assets/api/sign-up.php" method="POST">
                            <div class="w-full items-center flex space-x-2">
                                <div class="flex-1">
                                    <label for="first_name" class="block text-sm font-medium text-gray-700">ชื่อจริง
                                        *</label>
                                    <div class="relative">
                                        <input input id="first_name" name="first_name" type="text" autocomplete="" required=""
                                            class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-400 sm:text-sm"
                                            placeholder="ชื่อจริง" required />
                                    </div>
                                </div>
                                <div class="flex-1">
                                    <label for="last_name" class="block text-sm font-medium text-gray-700">นามสกุล
                                        *</label>
                                    <div class="relative">
                                        <input input id="last_name" name="last_name" type="text" autocomplete="" required=""
                                            class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-400 sm:text-sm"
                            ...
                            <div>
                                <label for="username" class="block text-sm font-medium text-gray-700">ชื่อผู้ใช้งาน
                                    *</label>
                                <div class="relative">
                                    <div
                                        class="absolute inset-y-0 start-0 top-0 flex items-center ps-3.5 pointer-events-none">
                                        <i class="fa-regular fa-user opacity-25"></i>
                                    </div>
                                    <input id="username" name="username" type="text" autocomplete="" required=""
                                        class="block w-full appearance-none rounded-md border border-gray-300 px-10 py-2 ps-9 placeholder-gray-400 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-400 sm:text-sm transition-all duration-200"
                                        placeholder="pmcshop" required />
                                </div>
                            </div>

                            <div>
                                <label for="email"
                                    class="block text-sm font-medium text-gray-700">ไปรษณีย์อิเล็กทรอนิกส์ @*</label>
                                <div class="relative">
                                    <div
                                        class="absolute inset-y-0 start-0 top-0 flex items-center ps-3.5 pointer-events-none">
                                        <i class="fa-regular fa-at opacity-25"></i>
                                    </div>
                                    <input id="email" name="email" type="email" autocomplete="" required=""
                                        class="block w-full appearance-none rounded-md border border-gray-300 px-10 py-2 ps-9 placeholder-gray-400 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-400 sm:text-sm transition-all duration-200"
                                        placeholder="pmcshop@email.com" required />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <div
                                        class="absolute inset-y-0 start-0 top-0 flex items-center ps-3.5 pointer-events-none">
                                        <i class="fa-regular fa-key-skeleton opacity-25"></i>
                                    </div>
                                ...
                                <p id="helper-text-explanation" class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                    ใช้รหัสผ่านที่มีความยาว <span class="text-red-500/70">6-9</span> ตัวอักษร</p>
                            </div>

                            <div>
                                <label for="password_confirm" class="block text-sm font-medium text-gray-700">ยืนยันรหัสผ่าน
                                    *</label>
                                <div class="relative">
                                    <div
                                        class="absolute inset-y-0 start-0 top-0 flex items-center ps-3.5 pointer-events-none">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-sm">
                                    <a href="#"
                                        class="font-medium text-sky-600 hover:text-blue-700 transition-colors duration-200">คุณลืมรหัสผ่านงั้นเหรอ?</a>
                                </div>
                            </div>

                            <div>
                                <button type="submit"
                                    class="w-full text-white bg-gradient-to-r from-sky-500 to-blue-600 hover:bg-gradient-to-r hover:from-sky-600 hover:to-blue-700 focus:ring-4 focus:outline-none focus:ring-sky-300 transition-all font-semibold rounded-md text-md px-3 py-1.5 text-center shadow-md duration-300">สร้างบัญชีใช้งาน</button>
                            </div>
                        </form>
                        ...
                        <div class="mt-6">
                            <div class="text-sm mt-3 space-x-1 flex items-center justify-center">
                                <div class="flex items-center">
                                    <p class="ml-2 block text-gray-900">คุณมีบัญชีแล้วเหรอ</p>
                                </div>

                                <a href="#"
                                    class="font-medium text-sky-600 hover:text-blue-700 transition-colors duration-200">เข้าสู่ระบบเลย!</a>
                            </div>
                        </div>
                    </div>
                </div>
